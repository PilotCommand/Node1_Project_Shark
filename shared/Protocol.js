...
export const MSG = {
  ...
  WELCOME: 1,           // Server → Client: You connected, here's your ID
  PLAYER_JOIN: 2,       // Server → Client: Another player joined
  PLAYER_LEAVE: 3,      // Server → Client: Another player left
  PING: 4,              // Client → Server: Latency check
  PONG: 5,              // Server → Client: Latency response
  
  // Movement (10-19)
  POSITION: 10,         // Client → Server: My position update
  BATCH_POSITIONS: 11,  // Server → Client: All players' positions
  
  // Game state (20-29)
  JOIN_GAME: 20,        // Client → Server: I selected my creature, ready to play
  CREATURE_UPDATE: 21,  // Client → Server: I changed creature (R key, N/B keys)
  SIZE_UPDATE: 22,      // Server → Client: Player size changed significantly
