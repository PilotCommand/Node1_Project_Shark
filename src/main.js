...
onSpawnRequested(async () => {
  ...
  Feeding.onEat((meal) => {
    if (meal.type === 'npc') {
      notifyEvent(`Ate a ${meal.preyDisplayName}! +${meal.volumeGained.toFixed(2)} mÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³`)
    }
...
console.log(`
ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€¦Ã‚Â¸ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚ÂÃƒâ€šÃ‚Â ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸Ãƒâ€šÃ‚Â¦Ãƒâ€¹Ã¢â‚¬Â  OCEAN CREATURE SIMULATOR
