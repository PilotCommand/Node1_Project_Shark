...
class NetworkManager {
  ...
  handleAbilityChange(data) {
    ...
    this.remotePlayers?.setAbilityState(playerId, abilityKey, isActive)
   ...
   */
  sendAbilityStart(abilityKey) {
    if (!this.connected) return false
    return this.send(MSG.ABILITY_START, { ability: abilityKey })
  }
